    ...
    window.TM07_PARAMETRIZATION_EXTRA = {
        ...
        sections: [
            ...
            },
            {
                ...
                note:
                    'Маски И1…И4 (п.71/72/74/75/77 — подсветка исполнения), даты, моточасы. ' +
                    'Перед очисткой регистров — закрытие калибровочного замка (п.317, 0x06AA←0). ' +
                    'Токи 309–314 убраны. Заряд 315 — только чтение. TestMode отключён.',
